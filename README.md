...
Copy **confluent-5.0.0/share/java/monitoring-interceptors/monitoring-interceptors-5.0.0.jar** package to local **libs/monitoring-interceptors** folder.  
_Confluent Platform_ (e.g. confluent-5.0.0) can be downloaded from [here](https://www.confluent.io/download/).  
