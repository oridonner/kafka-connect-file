...
Copy **confluent-5.0.0/share/java/monitoring-interceptors/monitoring-interceptors-5.0.0.jar** package from _Confluent Platform_ (can be downloaded from [here](https://www.confluent.io/download/)) to local **libs/monitoring-interceptors** folder.  
